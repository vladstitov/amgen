...
var amgen;
(function (amgen) {
    var FloorCampusArch = (function () {
        function FloorCampusArch(vo, dest) {
            this.trycount = 0;
        ...
        FloorCampusArch.prototype.parseSVG = function (res) {
            if (typeof res === 'string')
                res = JSON.parse(res);
            this.drawSvg(res);
            // console.log(res);
        };
        FloorCampusArch.prototype.setBuilding = function (building) {
            this.building = building;
        };
        FloorCampusArch.prototype.remove = function () {
            var that = this;
        ...
        FloorCampusArch.prototype.getList = function () {
            return this.list.getView();
        };
        FloorCampusArch.prototype.renderList = function () {
            // console.log(this.mapid);
            this.list.render();
        };
        FloorCampusArch.prototype.selectPolygonByWp = function (wpid) {
            if (Polygon.selected)
        ...
        FloorCampusArch.prototype.drawSvg = function (ar) {
            var polygons = [];
            var view = this.view;
        ...
        FloorCampusArch.prototype.setDemetions = function (w, h) {
            this.width = w;
            this.height = h;
        ...
        FloorCampusArch.prototype.show = function () {
            this.view.fadeIn();
            return this;
        };
        FloorCampusArch.prototype.showDestinationByCientId = function (clientid) {
            var that = this;
            if (!this.polygons) {
                setTimeout(function () {
        ...
        return FloorCampusArch;
    })();
    amgen.FloorCampusArch = FloorCampusArch;
...
//# sourceMappingURL=AmgenFloorsArch.js.map