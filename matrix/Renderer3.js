...
var Renderer3 = (function () {
    ...
    Renderer3.prototype.onMoveStart = function () {
    ...
    Renderer3.prototype.onMoveEnd = function () {
        this.stop();
    };
    Renderer3.prototype.onGestStop = function () {
        this.stopG = true;
        this.stop();
    };
    Renderer3.prototype.cFPS = function () {
    ...
    Renderer3.prototype.start = function () {
        if (!this.isActive) {
            this.isActive = true;
            this.onAnimationFrame(0);
        }
    ...
    Renderer3.prototype.stop = function () {
        var _this = this;
        clearTimeout(this.timeout);
    ...
    Renderer3.prototype.onAnimationFrame = function (st) {
        var _this = this;
        this.cFPS();
        if (this.isActive)
    ...
    Renderer3.prototype.stopTimer = function () {
        clearInterval(this.timer);
    };
    Renderer3.prototype.calcZR = function () {
    ...
    Renderer3.prototype.startGest = function () {
        this.isRS = true;
        $('#Gestur2').show();
    };
    Renderer3.prototype.stopGest = function () {
        this.isRS = false;
        $('#Gestur2').hide();
    };
    Renderer3.prototype.stopPos = function () {
        this.isPoz = false;
        $('#Move2').hide();
    };
    Renderer3.prototype.startPos = function () {
        this.isPoz = true;
        $('#Move2').show();
    };
    Renderer3.prototype.calcPosition = function () {
...
//# sourceMappingURL=Renderer3.js.map