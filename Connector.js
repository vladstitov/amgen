...
var AmgenConnector = {
    ...
    getCategories:function(){
        return $.get('/rest/web/category/all/'+this.deviceid+'/en');
    },
    getDestinations:function(){
        return $.get('/rest/web/destination/all/'+this.deviceid+'/en');
    },
    getStructure:function(){
        return $.get('/rest/web/maps/all/'+this.deviceid);
    },
    getMapData:function(){
        return $.get('/rest/web/maps/mapbuilderdata/'+this.deviceid);
    },
    ...
    getLabels:function(){
    return $.get('/rest/web/labels/'+this.deviceid+'/en');
}
}
/*
